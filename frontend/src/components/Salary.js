              ...
              <Statistic
                title={
                  <>
                    ...
                    <h6 style={{ color: "red" }}>Hoa hồng</h6>
                    <p>Tiền thưởng</p>
                  </>
                }
                value={salary?.salary?.seller.bonus.toLocaleString("it-IT", {
                  style: "currency",
                  currency: "VND",
                })}
              />
              ...
              <Statistic
                title={
                  <>
                    ...
                    <h6 style={{ color: "red" }}>Lương cơ bản</h6>

                    <p>Tiền lương cơ bản </p>
                  </>
                }
                value={salary?.salary?.seller.salary.toLocaleString("it-IT", {
                  style: "currency",
                  currency: "VND",
                })}
              />
                ...
                <>
                  ...
                  >
                    ...
                    <Col xs={24} md={12} className="d-flex">
                      <Button type="primary">Thêm thẻ ngân hàng</Button>
                    </Col>
                  </Row>
                </>
              }
